...
parrot = Parrot("RIZAL TRILAKSANA", 12, "blue")
parrot.speak() # Output: RIZAL TRILAKSANA is a blue parrot that talks
parrot.fly() # Output: RIZAL TRILAKSANA is flying with a wingspan of